...
object Implicits {
  ...
  // ------------------------------------------------------------------------- L*
  final implicit class LUnDiEdgeAssoc[N](e: UnDiEdge[N]) {
    def + [L](label: L) = LUnDiEdge[N,L](e._1, e._2)(label)
  }

  final implicit class LDiEdgeAssoc[N](e: DiEdge[N]) {
    def + [L](label: L) = LDiEdge[N,L](e._1, e._2)(label)
  }

  final implicit class LHyperEdgeAssoc[N](e: HyperEdge[N]) {
    def + [L](label: L) = LHyperEdge[N,L](e.nodes)(label)
  }

  final implicit class LDiHyperEdgeAssoc[N](e: DiHyperEdge[N]) {
    def + [L](label: L) = LDiHyperEdge[N,L](e.sources, e.targets)(label)
  }
  ...
  final implicit class XEdgeAssoc[N1](n1: N1) {
    ...
    def ~+ [N >: N1, N2 <: N, L](n2: N2)(l: L) =  LUnDiEdge[N,L](n1, n2)(l)
    def ~+#[N >: N1, N2 <: N, L](n2: N2)(l: L) = LkUnDiEdge[N,L](n1, n2)(l)
    ...
    def ~+> [N >: N1, N2 <: N, L](n2: N2)(l: L) =  LDiEdge[N,L](n1, n2)(l)
    def ~+#>[N >: N1, N2 <: N, L](n2: N2)(l: L) = LkDiEdge[N,L](n1, n2)(l)
  ...
  // ------------------------------------------------------------------ HyperEdge
  final implicit class XHyperEdgeAssoc[N1](e: EdgeLike[N1]) {
    // def ~%    [NU >: N1, N2 <: NU](n: N2)(w: Long) = new WHyperEdge[N](NodeProduct(e.iterator.toBuffer[N] += n), w)
    // def ~%#   [NU >: N1, N2 <: NU](n: N2)(w: Long) =    WkHyperEdge[N](e.iterator.toBuffer[N] += n)(w)
    def ~+ [NU >: N1, N2 <: NU, L](n: N2)(l: L) =  LHyperEdge[NU,L]((Vector[NU]() ++ e.nodes) :+ n)(l)
    def ~+#[NU >: N1, N2 <: NU, L](n: N2)(l: L) = LkHyperEdge[NU,L]((Vector[NU]() ++ e.nodes) :+ n)(l)
    // def ~%+   [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) =   WLHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
    // def ~%#+  [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) =  WkLHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
    // def ~%+#  [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) =  WLkHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
    // def ~%#+# [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) = WkLkHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
    

    // def ~%>    [NU >: N1, N2 <: NU](n: N2)(w: Long) = new WDiHyperEdge[N](NodeProduct(e.iterator.toBuffer[N] += n), w)
    // def ~%#>   [NU >: N1, N2 <: NU](n: N2)(w: Long) =    WkDiHyperEdge[N](e.iterator.toBuffer[N] += n)(w)

    // def ~+> [NU >: N1, N2 <: NU, L](n: N2)(l: L) =  LDiHyperEdge[NU,L]((Vector[NU]() ++ e.nodes) :+ n)(l)
    // def ~+#>[NU >: N1, N2 <: NU, L](n: N2)(l: L) = LkDiHyperEdge[NU,L]((Vector[NU]() ++ e.nodes) :+ n)(l)

    // def ~%+>   [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) =   WLDiHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
    // def ~%#+>  [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) =  WkLDiHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
    // def ~%+#>  [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) =  WLkDiHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
    // def ~%#+#> [NU >: N1, N2 <: NU, L](n: N2)(w: Long, l: L) = WkLkDiHyperEdge[N,L](e.iterator.toBuffer[N] += n)(w, l)
  }
  ...
  object :~ {
    ...
    def unapply[N](e: LUnDiEdge[N]): Option[(N, (N, e.L1))] =
      if (e eq null) None else Some(e._1, (e._2, e.label))

    def unapply[N](e: LkUnDiEdge[N]): Option[(N, (N, e.L1))] = // unapply(e: LUnDiEdge[N])
      if (e eq null) None else Some(e._1, (e._2, e.label))
  ...
  object :~> {
    ...
    def unapply[N](e:  LDiEdge[N]): Option[(N, (N, e.L1))] = // :~ unapply e
      if (e eq null) None else Some(e._1, (e._2, e.label))
    def unapply[N](e: LkDiEdge[N]): Option[(N, (N, e.L1))] = // :~ unapply (e: LUnDiEdge[N])
      if (e eq null) None else Some(e._1, (e._2, e.label))
